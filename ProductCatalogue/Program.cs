...
namespace ProductCatalogue // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
           ...
           // string jsonObject = JsonSerializer.Serialize(movieCatalogue, typeof(Movie), new JsonSerializerOptions()
           // {
           //     IncludeFields = true
           // });
           ...
           // string jsonObject2 = JsonSerializer.Serialize(bookCatalogue, typeof(Book), new JsonSerializerOptions()
           // {
           //     IncludeFields = true
           // });
